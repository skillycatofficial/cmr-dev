                ...
                <div className="flex gap-4 items-start p-5 bg-brand-green/5 border border-brand-green/15 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="font-body text-brand-charcoal/70 text-body leading-relaxed">
                      Phone: <a href="tel:+919206838383" className="text-brand-green hover:text-brand-gold transition-colors font-display font-bold text-lg">+91 9206 838 383</a> | <a href="tel:+917594962161" className="text-brand-green hover:text-brand-gold transition-colors font-display font-bold text-lg">+91 75949 62161</a><br />
