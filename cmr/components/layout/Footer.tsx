        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-x-4 gap-y-10 lg:gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 border-b border-brand-ivory/10 lg:border-none pb-10 lg:pb-0">
            ...
            <p className="font-body text-brand-ivory/70 text-body leading-relaxed max-w-[260px] mb-6">
              Union Complex, 2nd Floor, South Bazar,<br />
              Near Kannur–Taliparamba Highway,<br />
              Kannur – 670 001, Kerala
            </p>

            {/* Contact */}
            <div className="space-y-2 mb-6">
              <a href="tel:+919206838383" className="flex items-center gap-2 font-body text-brand-ivory/55 text-ui hover:text-brand-gold transition-colors duration-200">
              ...
              <a href="mailto:admin@cmrdevelopers.com" className="flex items-center gap-2 font-body text-brand-ivory/55 text-ui hover:text-brand-gold transition-colors duration-200">
                <svg className="w-3.5 h-3.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
